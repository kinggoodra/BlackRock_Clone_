...
export default memo(function TacticalViews() {
  ...
  return (
    <>
      ...
      <div className=" sm:block hidden overflow-y-auto h-[500px] mt-5">
        <table className="  h-auto m-1   ">
          ...
          {Universal.TacticalViews.filter((item) => {
            ...
            <tr className=" hover:bg-gray-100" key={index}>
              ...
              <th className=" p-5 text-start   sm:w-[100%]    ">
                <p className="text-md font-normal leading-6  text-black">
                  {item[2]}
                </p>
              </th>
            ...
            <AccordionContent>
              <small className="text-xs font-sans leading-5 inline-block ">
                <b>
                  ...
                  future results. It is not possible to invest directly in an
                  index.
                </b>{" "}
